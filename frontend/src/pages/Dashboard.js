...
function Dashboard() {
  ...
  return (
    <div style={s.page}>
      {/* Header */}
      <motion.div initial={{ opacity: 0, y: -16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: [0.16,1,0.3,1] }} style={s.header}>
        <div>
      ...
      <div style={s.statsGrid}>
        {[
          ...
          <motion.div key={i} initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 + i * 0.1, duration: 0.55, ease: [0.16,1,0.3,1] }} whileHover={{ y: -3, scale: 1.01 }}
      ...
      <div style={s.twoCol}>
        {/* Saving Goal */}
        {goal && (
          <motion.div initial={{ opacity: 0, x: -24 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35, duration: 0.55, ease: [0.16,1,0.3,1] }} style={s.card}>
        ...
        {/* Smart Insights */}
        <motion.div initial={{ opacity: 0, x: goal ? 24 : -24 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.45, duration: 0.55, ease: [0.16,1,0.3,1] }} style={s.card}>
          <div style={s.cardHeader}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={s.cardIconBox}>💡</div>
      ...
      {Object.keys(budgets).length > 0 && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55, duration: 0.5, ease: [0.16,1,0.3,1] }} style={s.card}>
      ...
      {/* Recent Transactions */}
      {recentTx.length > 0 && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.65, duration: 0.5, ease: [0.16,1,0.3,1] }} style={s.card}>
